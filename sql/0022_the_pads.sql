...
SELECT 'There are a total of ' + CONVERT(VARCHAR, COUNT(NAME)) + ' ' + LOWER(OCCUPATION) + 's.' FROM OCCUPATIONS GROUP BY LOWER(OCCUPATION) ORDER BY COUNT(NAME), LOWER(OCCUPATION);
